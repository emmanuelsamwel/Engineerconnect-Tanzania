...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans" id="master-app-root">
      ...
      {/* Simulation & Navigation Header */}
      <header className="bg-slate-900/95 sticky top-0 z-40 border-b border-white/5 backdrop-blur px-4 py-3">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2 bg-slate-950/80 p-1.5 rounded-full ring-1 ring-white/10 text-[10px] uppercase font-mono">
            <span className="text-slate-500 px-2 select-none">ACT AS:</span>
            {[
              ...
              <button
                ...
                className={`px-3 py-1 rounded-full transition-all text-[9.5px] font-black ${
                  userRole === role.id 
